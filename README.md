...
- 🎯 Currently pursuing **CPTS (Hack The Box)** and **SC-500: Cloud and AI Security Engineer Associate (Microsoft)**.
...
I actively hunt for and responsibly report security vulnerabilities. My findings have been acknowledged by:

-   🏈 **NFL** — Security Hall of Fame
-   💡 **Philips** — Security Hall of Fame
-   🖥️ **IBM** — Security Hall of Fame
-   🌐 **United Nations** — vulnerability triaged _(Hall of Fame listing pending)_
...
<details>
  ...
  <p>
    ...
    -   Application Security (AppSec): OWASP Top 10, Vulnerability Assessment
     <br/>
    -   Offensive Security: Web/API Pentesting, Phishing Simulations, Social Engineering
     <br/>
  </p>
</details>
...
<p>
  <strong>Technical Lead</strong> — ZeroCrypt (Cybersecurity Club)<br/>
  Architected distributed lab infrastructure (Docker, AWS) for cybersecurity simulations and conducted hands-on workshops for 40+ students.
</p>

<p>
  <strong>Security Consultant (Freelance)</strong><br/>
  Identified and reported critical and high-severity vulnerabilities across SaaS applications, mapped to the OWASP Top 10.
</p>
...
> 🎯 **In progress:** CPTS (Hack The Box) · SC-500 Cloud and AI Security Engineer Associate (Microsoft)
...
<details>
  ...
  <a href="">
    <img src="https://github.com/user-attachments/assets/02be94bd-ea82-4677-afd8-2c15caf9d983" alt="HTB CDSA Certificate" width="600">
  </a>
  <br><br>
...
<details>
  ...
  <a href="">
    <img src="assets/certs/thmjrpentester_page-0001.jpg" alt="THM Jr Penetration Tester" width="600">
  </a>
  <br><br>

  <h4>CyberSecurity Fundamentals</h4>
  <a href="">
    <img src="assets/certs/cybersec101.png" alt="THM CyberSecurity Fundamentals" width="600">
  </a>
  <br><br>

  <h4>Web Fundamentals</h4>
  <a href="">
    <img src="assets/certs/thmwebfundamentals_page-0001.jpg" alt="THM Web Fundamentals" width="600">
  </a>
  <br><br>
...
<details>
  ...
  <a href="https://app.letsdefend.io/certificate/show/c0d346a1-d7da-4ee1-8c3a-bd445f6273eb">
    <img src="assets/certs/malwarecert.png" alt="LetsDefend Malware Analysis Certificate" width="600">
  </a>
  <br><br>
  ...
  <a href="https://app.letsdefend.io/certificate/show/fd7c977e-6f79-4842-85bf-43641389f230">
    <img src="assets/certs/letsdefendwebattack.png" alt="LetsDefend Web Attack Detection Certificate" width="600">
  </a>
  <br><br>

  <h4>Programming For CyberSecurity</h4>
  <a href="https://app.letsdefend.io/certificate/show/06d1ae83-cf3b-4189-96e2-f498de03a109">
    <img src="assets/certs/letsdefendprogramming.png" alt="LetsDefend Programming for Cybersecurity Certificate" width="600">
  </a>
  <br><br>

  <h4>Non Stop</h4>
  <a href="https://app.letsdefend.io/my-rewards/detail/a3cccbd1-5060-40e8-9722-6ca17c212a03">
    <img width="600" alt="LetsDefend Non Stop Badge" src="assets/certs/letsdefendalert65.png" />
  </a>
  <br><br>

  <h4>Hunter - 2 Badge</h4>
  <a href="https://app.letsdefend.io/my-rewards/detail/b88c01b5cb0c4776b4437d7a7765a5f0">
    <img width="600" alt="LetsDefend Hunter 2 Badge" src="assets/certs/hunter2.png" />
  </a>
  <br><br>

  <h4>Hunter Badge</h4>
  <a href="https://app.letsdefend.io/my-rewards/detail/d61af313b6d949d98b9ada4e667dc458">
    <img width="600" alt="LetsDefend Hunter Badge" src="https://github.com/user-attachments/assets/eb098221-af71-4b74-8692-7ff222fff248" />
  </a>
  <br><br>
...
I regularly publish in-depth articles on malware analysis, reverse engineering, and decoding heavily obfuscated code — including a piece on Chrome zero-day exploitation that reached **6,000+ reads**. You can find my work on Medium.
...
<p align="center">
  <a href="https://linkedin.com/in/sohankanna">
